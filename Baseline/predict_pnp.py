...
if __name__ == "__main__":
    ...
    # model_path = '/ssdhome/lixuefei/code/CREPE/crepe_GRL/model/model_mdb_ziMF-PAM_clean/model_20.pth'
    model_path = '/ssdhome/lixuefei/code/CREPE/crepe_GRL/model/model_mdb_zipnp_clean/model_120.pth'
    # model_path = '/ssdhome/lixuefei/code/CREPE/crepe_GRL/model_mdb_zi_MF-PAM_noise/model_100.pth'  #  pnp2的模型
    # model_path='/ssdhome/lixuefei/code/CREPE/crepe_GRL/model_mdb_zi_pnp_noise/model_20.pth'
        ...
        for i in a:
            ...
            for wav in os.listdir(wav_dir_path):
                if wav == wav_name:
                    ...
                    # sound_data = get_frames(wav_path)
                    # sound_data = frames(wav_path,step_size=384/44100*1000)
                    # sound_data = sound_data.T
                    # sound_data = sound_data.unsqueeze(0).unsqueeze(0)
                    sound_data = sound_data.unsqueeze(0).to(device)   # torch.Size([1, 740, 1024])
                    # sound_data = sound_data.transpose(-1,-2)
